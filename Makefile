...
# Template: app
# Command: /usr/bin/qmake-qt5 -o Makefile cuarzobrowser.pro
#############################################################################
...
Makefile: cuarzobrowser.pro /usr/lib64/qt5/mkspecs/linux-g++/qmake.conf /usr/lib64/qt5/mkspecs/features/spec_pre.prf \
	...
	$(QMAKE) -o Makefile cuarzobrowser.pro
...
distdir: FORCE
	...
	$(COPY_FILE) --parents window.h topbar.h opbutton.h bookmarkbar.h hoverbutton.h $(DISTDIR)/
...
compiler_moc_header_make_all: moc_window.cpp moc_opbutton.cpp moc_hoverbutton.cpp
compiler_moc_header_clean:
	-$(DEL_FILE) moc_window.cpp moc_opbutton.cpp moc_hoverbutton.cpp
